        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (IdProducto != "")
                {
                    ...
                    imgImagen.ImageUrl = "~/Imagenes/Articulos/" + articulo.ImagenUrl;
                    lblDetalle.Text = articulo.Detalle;

                    repeaterRelacionados.DataSource = negocio.ListarPorCategoria(articulo.Categoria.Id.ToString());
                    repeaterRelacionados.DataBind();
                }
            }
            catch (Exception ex)
            {
